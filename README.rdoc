...
In Ruby 1.8.7, <tt>optparse.rb</tt> is <b>1,791</b> lines long!  Oh my dear lord! 
Even without comments, it's <b>875</b> lines of code.  That's long.
...
So ... this is my attempt to create a partially API-compatible implementation of 
OptionParser, which is more flexible and a LOT simpler.

I very likely won't support 100% of optparse's features, but I'll 
implement the features that 99% of people probably use.
